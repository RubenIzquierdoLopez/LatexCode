...
\input{Chapter_1_Introduction/Introduction}
...
\input{Chapter_2_Multisymplectic_Manifolds/2.1MultisymplecticVectorSpaces}
...
\input{Chapter_2_Multisymplectic_Manifolds/2.2MultisymplecticManifolds}
...
\input{Chapter_3_Hamiltonian_multivector_fields_and_forms/3.1HamiltonianMultivector}
\subsection{Hamiltonian multivector fields as Lagrangian submanifolds}\label{Subsection:HamiltonianAsLagrangian}
\input{Chapter_3_Hamiltonian_multivector_fields_and_forms/3.2HamiltonianMultivectorFieldsLagrangian}
\subsection{Complete lift of forms to multivector bundles}\label{Subsection:Completelift}
\input{Chapter_3_Hamiltonian_multivector_fields_and_forms/3.3CompleteLift}
...
\input{Chapter_4_Coisotropic_submanifolds/4.1Localforms}
\subsection{Coisotropic reduction}
\input{Chapter_4_Coisotropic_submanifolds/4.2CoisotropicReduction}

%-------------------------------------------
% Chapter_5: Conclusions+ Ackknowledgements
%-------------------------------------------
\section{Conclusions and further work}\label{conclusions}
\input{Chapter_5_Conclusions/conclusions}
